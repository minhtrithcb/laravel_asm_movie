...
<div class="breadcrumbs-area clearfix">
    <h4 class="page-title pull-left">Quản lý thông tin diễn viên</h4>
    <ul class="breadcrumbs pull-left">
        <li><a href="/">Dashboard</a></li>
        <li><span>Quản lý thông tin diễn viên</span></li>
    </ul>
</div>
@endsection
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row d-flex justify-content-between align-items-center pl-3 pr-3" style="height: 70px; ">
                        <h4 class="header-title m-0">Danh sách diễn viên</h4>
                        <button type="button" class="btn btn-primary " data-toggle="modal" data-target="#addmodel1">Thêm diễn viên</button>
                    </div>
                    <!-- Modal -->
                    @if ($errors->any())
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label for="tendienvien" class="form-label">Tên diễn viên</label>
                                                        <input type="text" class="form-control" id="tendienvien" name="tendienvien" value="{{old('tendienvien')}}">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="chieucao" name="chieucao" value="{{old('chieucao')}}">
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="cannang" name="cannang" value="{{old('cannang')}}">
